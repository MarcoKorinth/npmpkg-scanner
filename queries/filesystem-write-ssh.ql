/**
 * @name Write access to an ssh file
 * @description Package writes to a file used by the ssh client or daemon
 * @kind path-problem
 * @id filesystem-write-ssh
...
class SshFileAccessConfiguration extends TaintTracking::Configuration {
  ...
  override predicate isSink(DataFlow::Node sink) {
    exists(FileSystemWriteAccess f | sink = f.getAPathArgument())
  }
